...
class UpdateLeaderRequest extends FormRequest
{
    ...
    {
        return [
            'cedula' => ['required','numeric','max:9999999999','min:1000000',Rule::unique('leaders')->ignore($this->leader)],
    ...
    protected function failedValidation(Validator $validator){
        Alert::message('El lider no fue guardado, se presentaron los siguientes errores:', 'danger')->items($validator->errors());
