...
class UpdateVoterRequest extends FormRequest
{
    ...
    {
        return [
            'cedula' => ['required','numeric','max:9999999999','min:1000000',Rule::unique('voters')->ignore($this->voter)],
    ...
    protected function failedValidation(Validator $validator){
        Alert::message('El votante no fue actualizado, se presentaron los siguientes errores:', 'danger')->items($validator->errors());
