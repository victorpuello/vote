                ...
                columns: [
                    ...
                    { data: "sector",name:'sector', orderable: false, searchable: true },
                    {
                        data: "id", render: function (data, type, row) {
                            return '<a href="' + inf.data('url') + "/leaders/" + data + '/edit"' + ' class="on-default edit-row simple-ajax-modal"><i class="fas fa-pencil-alt"></i></a>  ' +
                                '<a href="#modalEliminar" data-nasg ="'+row.name+'" data-urldestroy = "' + inf.data('url') + '/leaders/' + data +'" class="on-default remove-row modal-basic " >' +
