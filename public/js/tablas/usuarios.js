                ...
                columns: [
                    ...
                    { data: "type",name:'type', orderable: false, searchable: true },
                    {
                        data: "id", render: function (data, type, row) {
                            return '<a href="' + inf.data('url') + "/users/" + data + '/edit"' + ' class="on-default edit-row simple-ajax-modal"><i class="fas fa-pencil-alt"></i></a>  ' +
                                '<a href="#modalEliminar" data-nasg ="'+row.username+'" data-urldestroy = "' + inf.data('url') + '/users/' + data +'" class="on-default remove-row modal-basic " >' +
